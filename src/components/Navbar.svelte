<script>
  ...
  async function handleDeleteAccount() {
    ...
    try {
      ...
      window.__showToast?.(
        e.message ||
          "Failed to delete account. You may need to sign out and sign in again first.",
        "error",
      );
    } finally {
      deleting = false;
    ...
    <a href="/#/" class="brand">
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        ...
        <text
          ...
          font-weight="700"
          fill="white"
          font-family="'Geist Mono', monospace">.rc</text
        >
      </svg>
          ...
          {#if dropdownOpen}
            <div class="dropdown-menu">
              <div class="dropdown-header">
                <span
                  style="font-weight:600;display:block;white-space:nowrap;overflow:hidden;text-overflow:ellipsis"
